...
NidecBLDC motor2{ 7, 8, 9, 10, 11, 100.0f };
// NidecBLDC motor3{ 16, 17, 18, 19, 20, 10.0f };
...
void setup() {
  ...
  motor2_pid.init({ 0.01f, 4000.0f, 0.0f, 25.0f, 0.0f, 32767.0f });
  // motor3_pid.init({ 0.01f, 4000.0f, 0.0f, 25.0f, 0.0f, 32767.0f });
...
void loop() {
  ...
  float motor2_output = motor1_pid.solve(motor1.getRad() - motor2.getRad());
